...
|              Вход в систему               |                       Текущий забег                       |
|:-----------------------------------------:|:---------------------------------------------------------:|
| ![Вход](documentation/app_demo/login.png) | ![Список забегов](documentation/app_demo/current_run.png) |

|                      Список забегов                      |                      Детали забега                      |
|:--------------------------------------------------------:|:-------------------------------------------------------:|
| ![Текущая пробежка](documentation/app_demo/run_list.png) | ![Детали забега](documentation/app_demo/run_detail.png) |
...
- **Безопасность**: [Firebase App Check](https://firebase.google.com/docs/app-check) с провайдером Play Integrity для верификации подлинности приложения и защиты доступа к облачным ресурсам.
...
В папке [documentation](documentation) представлены визуальные схемы архитектуры и инфраструктуры приложения. Все исходники в формате PlantUML доступны там же.

#### 🧩 Логическая архитектура приложения
В папке проекта доступны две версии диаграммы: базовая и расширенная (со всеми связями).

**Базовая схема:**
![Базовая архитектура](documentation/app_architecture/architecture.png)

**Расширенная схема:**
![Полная архитектура](documentation/app_architecture/architecture_full.png)
...
![Текущая инфраструктура](documentation/infrastructure/original.png)
...
![Масштабируемая инфраструктура](documentation/infrastructure/substituted.png)
